 ...
 * Created by Will
 */
public class PlaceRiceTileCommand extends MovableCommands {
    ...
    //TODO I assume there is a method in gameController that accesses the communal inventory
        int count = gameController.getInventory().getItem("riceTile");
        if(count<=0){
        ...
        //TODO I assume boardController has a sort of placeTile() method
            gameController.getInventory().setItem("riceTile", count-1);
    ...
    public void undo(){
        ...
        gameController.getInventory().setItem("riceTile", gameController.getInventory().getItem("riceTile")+1);
