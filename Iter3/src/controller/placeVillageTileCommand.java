...
public class PlaceVillageTileCommand extends Command {
    ...
    //private Space s;
    public PlaceVillageTileCommand(BoardController boardController, GameComtroller gameController){
    ...
    /*
    int count = gameController.getItem("villageTile");
    if(count<=0){
    ...
    */
    ...
    public void undo(){
        ...
        /*gameController.setItem("villageTile", gameController.getItem("villageTile")-1);
