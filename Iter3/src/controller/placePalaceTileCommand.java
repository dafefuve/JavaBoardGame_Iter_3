...
public class PlacePalaceTileCommand extends Command {
    ...
    //private Space s;
	public PlacePalaceTileCommand(BoardController boardController, GameComtroller gameController){
    ...
    /*
    int count = gameController.getItem("palaceTile");
    if(count<=0){
    ...
    */
    ...
    public void undo(){
        ...
        /*gameController.setItem("palaceTile", gameController.getItem("palaceTile")-1);
